                  ...
                  child: !isLoading? RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      if(_image.length<1){
                        ...
                        Firestore.instance.collection("Products").add(userMap).then((value) async {
                          ...
                          AddProduct feedbackForm = AddProduct(
                              value.documentID,
                              title,
                              price,
                              description
                          ...
                          AddProductController formController = AddProductController((String response) {
                            print("Response: $response");
                            if (response == AddProductController.STATUS_SUCCESS) {
