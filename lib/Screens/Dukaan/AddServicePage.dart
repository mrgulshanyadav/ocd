...
import 'Controller/AddServiceController.dart';
                ...
                _image.length>0? Container(
                  ...
                  child: GridView.builder(
                      ...
                      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                        ...
                        childAspectRatio: (MediaQuery.of(context).size.width-20) / ((MediaQuery.of(context).size.height-20) / 2),
                      ),
                  ...
                  child: !isLoading? RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      _scaffoldKey.currentState.showSnackBar(new SnackBar(content: Text('Select Atleast 1 Service Image!')));
                        ...
                        Firestore.instance.collection("Services").add(userMap).then((value) async {
                          ...
                          AddService feedbackForm = AddService(
                              value.documentID,
                              title,
                              price,
                              description
                          ...
                          AddServiceController formController = AddServiceController((String response) {
                            print("Response: $response");
                            if (response == AddServiceController.STATUS_SUCCESS) {
