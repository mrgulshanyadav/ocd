...
import '../Enquire/Model/EnquireProductForm.dart';
import 'Controller/EnquireProductFormController.dart';

class EnquireProductPage extends StatefulWidget {
  Map<String, dynamic> postMap;
  String id;

  EnquireProductPage({this.postMap, this.id});

  @override
  _EnquireProductPageState createState() => _EnquireProductPageState();
}

class _EnquireProductPageState extends State<EnquireProductPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Enquire Product"),),
      key: _scaffoldKey,
      body: SafeArea(
