...
class RatingsAnalysis extends StatefulWidget {
  String rest_id, rest_name;

  RatingsAnalysis({@required this.rest_id, @required this.rest_name});
...
class _RatingsAnalysisState extends State<RatingsAnalysis> {
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    width: screenWidth,
                    child: Text(
                      "Restaurant "+(widget.rest_name??"") + " - Avg Rating for each quality attribute",
                      style: TextStyle(
                          fontSize: 18,
                          color: Colors.black
                      ),
  ...
  Future<List<Map<String, dynamic>>> getReviewsListsFromDatabase(
      String rest_id) async {
